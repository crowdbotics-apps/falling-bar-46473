"""
Django settings for falling_bar_46473 project.
...
ROOT_URLCONF = 'falling_bar_46473.urls'
...
WSGI_APPLICATION = 'falling_bar_46473.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_bar_46473 API",
    "DESCRIPTION": "API documentation for falling_bar_46473 App",
    "VERSION": "v1",
}
